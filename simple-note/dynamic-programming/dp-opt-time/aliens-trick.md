...
[題目連結](https://www.luogu.com.cn/problem/P4983) 幾乎同一題
...
一樣，透過觀察~~打表~~可以發現$$dp(i)$$是一個凸的函數，所以我們可以考慮使用Aliens。使用 Aliens 的話也就是每多選一塊需要多花$$k$$的價值，所以 DP 式變成：
...
1. [\[IOI 2000\] 郵局](https://tioj.ck.tp.edu.tw/problems/1986/)
